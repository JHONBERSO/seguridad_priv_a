...
----------------------------------------------------------------------------------------------
## Interfaces del proyecto en Android Studio

---

## 1. Permisos en Android (CÁMARA)

| ![Imagen 1](https://github.com/user-attachments/assets/c68afffc-0bee-4374-81f0-323d4dd7c439) | ![Imagen 2](https://github.com/user-attachments/assets/d510ccf7-2420-4229-8fdd-b51a5203aa2a) | 
|:--:|:--:|
...
## 2. Permisos en Android (GALERÍA)

| ![Imagen 1](https://github.com/user-attachments/assets/614e27e8-42e3-4a51-855c-2ca719ad1a87) | ![Imagen 2](https://github.com/user-attachments/assets/f11343fe-42b2-4166-81de-4d9c093df2f7) |
|:--:|:--:|

Ambas imágenes muestran el flujo de trabajo para obtener y utilizar el permiso de galería, destacando cómo la aplicación intenta manejar la seguridad y la privacidad de los datos, lo cual es el foco principal del documento de evaluación técnica.

---

## 3. Permisos en Android (MICRÓFONO)

| ![Imagen 1](https://github.com/user-attachments/assets/6f530a7a-7a12-47dc-a4c8-9fb2b2a8feb4) | ![Imagen 2](https://github.com/user-attachments/assets/fd2da664-e038-42c4-951e-350ae399f0df) |
|:--:|:--:|
...
| ![Imagen 1](https://github.com/user-attachments/assets/5e71c327-9a3d-4396-88d3-b2418a17e8ed) | ![Imagen 2](https://github.com/user-attachments/assets/3df13e26-cdb3-4410-b9c1-f6d5fef8f26d) |
|:--:|:--:|
...
## 5. Permisos en Android (TELÉFONO)

| ![Imagen 1](https://github.com/user-attachments/assets/9f355f9b-d599-437e-957d-30bfd5e39d9d) | ![Imagen 2](https://github.com/user-attachments/assets/aa5c0c90-c3d8-4bd2-9d28-bdd85a6d3188) |
|:--:|:--:|
| ![Imagen 3](https://github.com/user-attachments/assets/5783f34b-3019-43f4-bb63-0180717dddba) | |
...
| ![Imagen 1](https://github.com/user-attachments/assets/f9210982-a325-48fe-a901-df737ed82a6e) | ![Imagen 2](https://github.com/user-attachments/assets/e71e9a96-c6a3-4b0a-94f8-7b9e79855f20) |
|:--:|:--:|

Este diálogo se corresponde con la gestión de permisos peligrosos en tiempo de ejecución, en particular con el permiso `android.permission.ACCESS_COARSE_LOCATION`. Su presentación demuestra que la aplicación sigue las mejores prácticas de privacidad de Android al dar al usuario un control detallado sobre sus datos de ubicación.

---

## 7. Permisos en Android (PROTECCIÓN DE DATOS)

| ![Imagen 1](https://github.com/user-attachments/assets/ce813a79-53a9-4fb4-88ec-183c13a79422) |
|:--:|
...
## 8. Permisos en Android (POLÍTICAS DE PRIVACIDAD)

| ![Imagen 1](https://github.com/user-attachments/assets/541df473-0d32-4e06-a748-2a0c6239da8b) |
|:--:|
